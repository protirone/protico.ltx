...
* 2.1: __Beschreiben Sie die innere Struktur von MAC-Adressen.__ (3P)
* 2.2: __Welche IPv4-Adressen spezifizieren ein IPv4-Netz__. (1 Punkt)
* 2.3: __*Wie nennt man Rechner mit mehr als einer aktiven Netzwerkkarte, die in unterschiedlichen Netze kommunizieren?*__ (1ZP)
* 2.4: __*Wie viele MAC- und IPv4-Adressen verwaltet ein Rechner mit n aktiven Netzwerkkarten, die in unterschiedlichen Netze kommunizieren?*__ (3ZP) 
...
* Netzadresse, Subnetzmaske, Broadcastadresse, Gatewayadresse
* Router
* n MAC-Adressen + n * (Netzadresse, Subnetzmaske, Broadcastadresse, Routeradresse)
