...
### 1. Secure Shell (ssh) in der Theorie **[→ ZP:Sheet2]**
...
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:01**</span>
...
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:02**</span>
...
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:03**</span>
...
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:04**</span>
...
### 5. Komplexes Tunneling 

#### A
Zusammenfassung **[→ ZP:Sheet3]**

Eine SSH-Verbindung folgt dem Client-Server-Model. Aber mehr als singuläres Request:Response:

* 1. Request-Anfrage
* 2. allgemeiner Schlüsselaustausch
* 3. Identitätsabsicherung (gegen Man-In-The-Middle)
* 4. Useridentifizierung (Passwort oder authorized_keys)
* 5. Loop:
  * a. Client: Command-Eingabe auf Client-Shell
  * b. Client: Command-Verschlüsselung mit Server-Public-Key
  * c. Client/Server: Übertragung
  * d. Server: Command-Entschlüsselung mit Server-Private-Key
  * e. Server: Command-Übergabe an Server/User-Shell
  * f. Server/User-Shell: Command-Ausführung in Server/User-Shell
  * g. Server/User-Shell: Output/Ergebnis-Übergabe an ssh-Server
  * h. Server: Output/Ergebnis-Verschlüsselung mit Client-Public-Key
  * i. Server/Client: Übertragung
  * j. Client: Output/Ergebnis-Entschlüsselung mit Client-Private-Key
  * k. Client: Output/Ergebnis-Anzeige in Client-Shell


---

<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:05**</span>

1. Rekapitulieren Sie, was der Befehl (I) `ssh gsldkm@SERVERIP` tut.
2. Beschreiben Sie als Schrittfolge, was der Befehl (II) `ssh gsldkm@SERVERIP -L 9000:SERVERIP:80` tut.
...
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF09/17:SSH:06**</span>

1. Wiederholen Sie die Aufagbe 04 so, dass Sie von Ihrem Rechner aus einen Tunnel zum ssh-Serverrechner aufbauen und sich über ihn die Schulhomepage `https://www.gs-ldk.de/` anzeigen lassen.
...
0. Bilden Sie 3 Gruppen
1. Konzipieren Sie je Gruppe eine Software, die die Lösung von 5.2 generalisiert.
2. Spezifizieren Sie, auf welchen Layern Ihre Lösung arbeiten müsste.
3. Finden Sie einen Namen für Ihre Lösung
4. Präsentieren und erläutern Sie Ihre Gruppenlösung Ihren Mitschülerinnen.
