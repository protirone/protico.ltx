...
# Schreiben Sie ein Skript, dass die Datei, die sh2go erzeugt hat
# einliest und die Anzahl der Einträge liest, einmal inklusive
# Doubletten, einmal ohne Doubletten
